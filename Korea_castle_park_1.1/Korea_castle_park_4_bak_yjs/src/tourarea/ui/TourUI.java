...
public class TourUI {
	...
	public void addKorea() {
		...
		boolean resultInsertTour = false;
		switch (inum) {
		case 1:
			sc.nextLine();
			...
			tourarea = new TourArea(name, fee, starttime, closetime, subwayline, parking, languageNum);
			resultInsertTour = manager.insertTour(tourarea);
			if (resultInsertTour == true) {
		...
		case 2:
			...
			tourarea = new Park(name, fee, starttime, closetime, subwayline, parking, languageNum, location,
					manageoffice);
			resultInsertTour = manager.insertTour(tourarea);
			if (resultInsertTour == true) {
